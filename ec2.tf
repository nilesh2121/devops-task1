...
resource "aws_instance" "webserver" {
    ...
    provisioner "remote-exec" {
      inline = [
        ...
        "sudo scp -i  /home/devops/.ssh/id_rsa.pub devops@aws_instance.webserver.private_ip:/home/devops/.ssh/ -o StrictHostKeyChecking=no"
   ...
   connection {
    ...
    provisioner "remote-exec" {
      inline = [
        ...
        "sudo scp -i /home/devops/.ssh/id_rsa.pub devops@aws_instance.dbserver.private_ip:/home/devops/.ssh/ -o StrictHostKeyChecking=no"
